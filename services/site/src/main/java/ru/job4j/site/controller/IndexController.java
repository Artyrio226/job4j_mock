...
public class IndexController {
    ...
    public String getIndexPage(Model model, HttpServletRequest req) throws JsonProcessingException {
        ...
        Map<Integer, Optional<ProfileDTO>> collect = interviewDTOList.stream()
                .collect(Collectors.toMap(InterviewDTO::getId, dto -> profilesService.getProfileById(dto.getSubmitterId())));
        model.addAttribute("profiles", collect);
        return "index";
    }
}